						    ...
						    @csrf
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control " name="username" placeholder="Masukkan username Anda" value="{{old('username')}}">
                                        <span style="color: red">@error('username'){{ $message }} @enderror</span>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control " name="waktu_kunjungan" placeholder="Masukkan waktu kunjunngan Anda" value="{{old('waktu_kunjungan')}}">
